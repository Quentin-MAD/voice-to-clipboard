...
export const Route = createFileRoute("/legal/privacy")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://talking-translator.com/legal/privacy" },
    ],
    links: [{ rel: "canonical", href: "https://talking-translator.com/legal/privacy" }],
  }),
});
        ...
        <div className="prose prose-invert mt-8 max-w-none text-sm text-foreground/90 space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Security, fraud and abuse prevention - <em>legitimate interests</em>.</li>
