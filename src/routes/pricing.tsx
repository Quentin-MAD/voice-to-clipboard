    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          1 crédit Texte = 1 traduction vocale (F8) : vous parlez, TalKing écrit la traduction dans votre presse-papiers. 1 crédit Vocale = 1 lecture à voix haute (F9) : vous donnez un pseudo, TalKing lit le message du joueur dans votre langue. Le compte Gratuit reçoit 20 traductions Texte et 10 lectures Vocales offertes chaque jour (non cumulables), plus 15 dialogues mobiles par jour. Au-delà, il faut acheter des crédits ou prendre l'abonnement, qui supprime toutes les limites.
        </p>
