  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex max-w-xl flex-col items-center gap-4 px-4 py-24 text-center">
        ...
        <a
          href="/__l5e/assets-v1/d61c2abc-3525-4834-85ee-57bd71b9b436/TalKing-Setup-0.10.10.exe"
          download="TalKing-Setup-0.10.10.exe"
          ...
          {!isElectron && (
            <div className="mb-6 rounded-xl border border-primary/40 bg-primary/5 p-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                >
                  ⬇ Télécharger l'installeur v0.10.10 (.exe, 99 Mo)
                </a>
                <a
